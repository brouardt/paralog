...
class Paralog_Activity extends Paralog_Table
{
	...
	public function form_edit()
	{
		...
		} else if ( isset( $_REQUEST['plateform_action'] ) ) {
		...
		} else if ( isset( $_REQUEST['winchman_action'] ) ) {
            ...
            <h1><?php _e( "Fiche d'activité", PL_DOMAIN ); ?>
                <a class="add-new-h2"
                   href="<?php echo get_admin_url(
					   get_current_blog_id(),
					   sprintf(
						   'admin.php?page=paralog-activities&paged=%d',
						   $this->get_pagenum()
					   ) ); ?>">
	...
	public function activity_form_meta_box_handler( $item )
	{
        ...
        <table cellspacing="2" cellpadding="5" style="width: 100%;" class="form-table">
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="line_name">
						<?php _e( 'Nom de la ligne', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="start_wind_orientation">
						<?php _e( 'Orientation du vent en début de séance', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
                    <select id="start_wind_orientation" name="start_wind_orientation">
						...
						<?php foreach ( $orientations as $orientation ): ?>
                            <option value="<?php echo esc_attr( $orientation ); ?>"
								<?php echo( $orientation == $item['start_wind_orientation'] ? 'selected' : '' ); ?>>
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="start_counter">
						<?php _e( 'Compteur en debut de séance', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="start_gazoline">
						<?php _e( 'Niveau de carburant en debut de séance', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="start_time">
						<?php _e( 'Heure du début de séance', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="end_wind_orientation">
						<?php _e( 'Orientation du vent en fin de séance', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="end_counter">
						<?php _e( 'Compteur en fin de séance', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="end_gazoline">
						<?php _e( 'Niveau de carburant en fin de séance', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="end_time">
						<?php _e( 'Heure de fin de séance', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
            ...
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="winch_incident">
						<?php _e( 'Incident de treuil', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
                    <textarea name="winch_incident"
                              class="code"><?php echo esc_html( $item['winch_incident'] ); ?></textarea>
                </td>
            </tr>
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="fly_incident">
						<?php _e( 'Incident de vol', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
                    <textarea name="fly_incident"
                              class="code"><?php echo esc_html( $item['fly_incident'] ); ?></textarea>
                </td>
            </tr>
            <tr class="form-field">
                <th valign="top" scope="row">
                    <label for="comment">
						<?php _e( 'Commentaire', PL_DOMAIN ); ?>
                    </label>
                </th>
                <td>
                    <textarea name="comment"
                              class="code"><?php echo esc_html( $item['comment'] ); ?></textarea>
                </td>
            </tr>
            </tbody>
        </table>
